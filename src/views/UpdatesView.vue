<template>
  ...
  <div class="card card-body bg-light mb-3">
    ...
    <ul>
      ...
      <li>Website preset for Crosskeys now an item accessibility setting of <i>100% Locations</i> instead of <i>100% Inventory</i>.</li>
    </ul>
    <li>Bug Fixes</li>
    <ul>
  ...
  <div class="card card-body bg-light mb-3">
    <li>New Features</li>
    <ul>
      <li>The randomizer now uses a new font that is more compact and contains lowercase characters! Thank you to
        total, kan, kara, Aerinon, and cassidymoen for the work on this feature.</li>
      <li>A new goal called "Ganonhunt" has been added! This goal is similar to the "Triforce Pieces" goal, but
        requires the player to defeat Ganon after collecting the triforce pieces instead of turning them into
        Murahdahla.</li>
      <li>Players may now include lowercase letters and numbers in their file name.</li>
      <li>Winners of the 2022 Main Tournament, and 2022 No Logic tournaments have been added to their respective
        in-game signs.</li>
    ...
    <ul>
      ...
      <li>Fixed a bug that causes the item in the potion shop to vanish (until the next screen transition) when
        fluting from race game to potion shop. Thanks catobat!</li>
      <li>Fixed a very small issue that could cause some vanilla glitches to not work properly under certain
        conditions.</li>
      <li>Fixed an bug that could allow interaction with a goal NPC (such as Murahdahla) while the player has their
        menu open.</li>
      <li>Fixed a bug where player could buy a shop shield and upgrade it's level improperly beyond what is allowed by
        the current item pool setting.</li>
      <li>Fixed a bug where the player would spawn at the post-aga starting entrance if they died or saved and quit in
        the "opposite" world of the old man (dark world or light world in inverted) with Agahnim 1 dead and the
        mirror collected.</li>
      <li>The player may now toggle the "free item menu" at the bottom of the menu even when they have no menu items.
        Previously the menu would close.</li>
      <li>Inverted: Corrected a problem where the logic did not account for access to a fire source when fighting
        Ganon. Thanks MichaelK__</li>
      <li>Inverted: The logic now allows mirroring to catfish when the player can get to the Light World Zora area.
      </li>
      ...
      <li>The vanilla "sword and shield" item properly increments total item counter. This item is only used in
        customizer games.</li>
    ...
    <ul>
      ...
      <li>A Black Screen of Death (BSOD) has been added which "detects" ingame crashes and supplies debug information.
      </li>
      <li>Full SRAM rework by cassidymoen. <a href="https://github.com/KatDevsGames/z3randomizer/pull/159">See the pull
        request for details.</a> Developers of autotrackers may want to test their software to ensure it works
        with v31.1.</li>
  ...
  <div class="card card-body bg-light mb-3">
    <li>New Features</li>
    <ul>
      <li>Failing a Fake Flippers by taking a hit will now work like it does in the original game, except the player
        will be locked in place preventing the softlock. The player may then Save & Quit normally.
        <br /><i>* Dev note: This new change will cover more cases where the player could get softlocked, such as in
          Enemizer when taking a 0-hp hit.</i>
      </li>
      <li>Item shops will now properly account for Hard item pool and prevent purchasing of shields accordingly.
        Thanks compiling.</li>
      <li>More Blind Puns! Thanks PuzzleSecretary</li>
      <li>When playing glitched modes, Agahnim's Tower door will always be unlocked during the Standard world state
        escape sequence.</li>
      <li>Added API support for enabling "Pseudo Boots".</li>
    </ul>
    <li>Bug Fixes</li>
    <ul>
      <li>Item sprites that are "narrow" (8x16) will now properly render when replacing a shield or progressive bow.
        Thanks cassidymoen!</li>
      <li>Changed the Exploration Glitch fix to be appropriately applied to No Glitches, instead of glitched games.
        Thanks kan!</li>
      <li>Removed the remaining logic when playing No Logic and Standard world state.</li>
      <li>Diggable portal locations will no longer appear in the Light World when playing Inverted world state. Thanks
        cassidymoen.</li>
    ...
    <ul>
      <li>Reverted quadrant glitch fix (as it was not working as intended). This was changed mid-release in Sept 2021.
      </li>
      <li>"Death hole", a vanilla bug that could cause memory corruption and incompletable games, is now fixed in No
        Glitches games. Thanks kan!</li>
    </ul>
    <li>Miscellaneous changes</li>
    <ul>
      <li>To reduce the patch's size, the "Don't Use ZSNES" image was removed from the ROM. The check will still
        occur, and the game will refuse to start if using ZSNES or other incompatible emulators.</li>
      <li>The sound engine was moved back to it's vanilla location. Thanks kan!</li>
    </ul>
    <li>Added new player options<br>
      <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.31.0.11.lg.png" alt="Player sprite options"
         style="width:50%" />
    </li>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      <li>New Features</li>
      <ul>
        <li>Magic used, and damage taken, are now statistics that are tracked and shown in the credits. Thanks kan!
        </li>
        <li>Boss icons will now appear on the dungeon map, indicating the dungeon's boss. This only appears if the
          player has the compass for that dungeon. Thanks kan for the code; _aitchFactor, vortexofdoom, and
          PlaguedOne for the art!</li>
        <li>The dungeon prize (Crystals and Pendants) will now appear as a "C" or "P" indicator on the HUD while in
          a dungeon. Thanks kan!</li>
        <ul>
          <li>This only appears when maps are not shuffled in the wild (Dungeon Item Shuffles other than
            Standard), or you have the map for the dungeon.</li>
        </ul>
        <li>Sound effect rando! There is now an option to randomize your game's sound effects. Thanks Aerinon!</li>
        <li>Item drop RNG during the escape sequence while playing Standard World State is now the same for all
          players of the same seed. Thanks Cassidymoen!</li>
        <li>MSU-1 Resume, introduced in v31.0.9, may now be disabled.</li>
      </ul>
      <li>Bug Fixes</li>
      <ul>
        <li>Fixed a situation that could cause players to hardlock when dropping down to a boss fight, such as
          Mothula and Kholdstare. Thanks Qwertymodo!</li>
        <li>The proper sprite will now be drawn when a progressive bow appears in an open location. Thank you Bonta.
        </li>
        <li>Consecutive special quickswaps (such as switching between bottles) will now be properly handled. Thank
          you Bonta.</li>
        <li>Inverted: It is no longer possible to bypass the Ganon's Tower opening animation when opening the
          entrance to GT at Hyrule Castle. Thanks kan!</li>
        <li>Customizer: Triforce and Bow are now properly labeled as advancement items, which allows them to be
          placed randomly. Thank you compiling.</li>
      </ul>
      <li>Vanilla bug fixes</li>
      <ul>
        <li>These apply to No Glitches games only. Glitched games (OWG, MG, No Logic) are not affected. Thank you
          kan for the fixes.</li>
        <ul>
          <li>The disarming of Exploration Glitch has been expanded from Palace of Darkness to all Save & Quits.
          </li>
          <li>"Jingle Glitch", which can cause sprite despawns in Ganon's Tower and Ice Palace, has been fixed.
          </li>
          <li><del>"Quadrant Glitch", which can cause camera related issues when performing a sword spin under
            certain circumstances, has also been fixed.</del> This change was reverted.</li>
        </ul>
      </ul>
      <li>Other changes</li>
      <ul>
        <li>The "OWG Landbridge" sign has been updated to add the winner of the Hybrid Major Glitches 2021
          Tournament</li>
        <li>The Houlihan sign has been updated to add the winner of the 2021 Main Tournament.</li>
      </ul>
    </ul>
    <li>Added new player options<br />
      <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.31.0.10.lg.png" alt="Player sprite options"
           style="width:50%" />
    </li>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <ul>
        ...
        <li>The credits have been updated to include additional individuals we want to recognize for their
          contributions to this project.</li>
        <li>The speed of the epilogue and credits can be increased 4x the normal speed by pressing and holding X.
        </li>
        <ul>
          <li>You may experience some minor graphical glitches when using this feature. This is a known issue due
            to technical limitations.</li>
          <li>Music will play at normal speed, and sprites will still move at normal speed. This feature only
            increases the speed of camera scrolling.</li>
        </ul>
        <li>The author of the sprite you're using will now appear in the end credits.</li>
        <li>When underworld clips are enabled, a new line will appear in the menu indicating what bosses have been
          defeated.</li>
        <li>The bottles now work like other items that share an inventory space when using Quickswap. Press L+R to
          swap bottles. Thanks kedNalatacId!</li>
        ...
        <li>The MSU-1 track playing in the overworld will now resume where it left off when returning to the
          overworld, assuming the same track is playing. Thanks Bonta!</li>
        <ul>
          <li>Not every platform will support this feature. This feature is known to work on the latest
            sd2snes/Fxpak, Snes9X, and bsnes/higan. Revision 2 of MSU-1 is required.</li>
        </ul>
      </ul>
      <li>Bug Fixes</li>
      <ul>
        <li>Finding a map in Hyrule Castle will now properly show the map on your item menu while in the Sewers
          section of Hyrule Castle.</li>
        <li>Enemizer: Firebars will now only damage the player if the firebar is on the same layer as Link.</li>
        <li>Customizer: Fixes a bug that prevented a change in starting hearts to be saved if you click on the
          slider instead of dragging the slider. Thanks Dr. Blue!</li>
        <li>Low health beeping will no longer occur if your max health is 1 or 2 hearts. Once you have at least
          three hearts, the normal beeping behavior will occur.</li>
      </ul>
      <li>Other changes</li>
      <ul>
        <li>The website will now, by default, generate games where Quickswap is allowed. This can still be disabled
          via the API.</li>
        <li>Customizer: Will now default to enabling spoilers on generated games. This can still be set to Disabled,
          On Generate, or Mystery as needed.</li>
        <li>Overworld YBA now puts Moon Pearl-less access to Ganon in logic</li>
      </ul>
      <li>Website content updates</li>
      <ul>
        <li>Overhauled the <a href="/races">Organized Play</a> page to include better information on all major
          competitive play.</li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Entrance Randomizer: Silvers are now appropriately available at all times when choosing Swordless and Normal
        Item Functionality</li>
      ...
      <ul>
        ...
        <li>Ensures the key in the Tower of Hera basement cage is counted in autotrackers when that item is a Tower
          of Hera small key. Thank you Aerinon!</li>
        <li>Memory values such as prize pack drops are now properly cleared from memory when a new file is created
          on the same ROM. Thanks Catobat!</li>
        <li>The prize drop sequences are now reset on Save & Quit, which is consistant with vanilla ALTTP behavior.
          Also thank you Catobat!</li>
        <li>All starting equipment will now appear on new file creation. Previously, some items that shared a slot
          would not appear until after the first Save & Quit. Yea, Catobat did this too.</li>
      </ul>
      <li>Added new player options<br />
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <ul>
        ...
        <li>Fixes a rare issue with specific SNES consoles and custom shops causing VRAM corruption or crashes.
          Thank you Bonta for identifying the cause of this issue.</li>
        <li>Fixes a very rare issue where the game may crash on a Save and Quit.</li>
        <li>Fixes an issue where dying in the high stakes chest game in the Lost Woods results in respawning at the
          pyramid, regardless of the status of Agahnim 1 or the Magic Mirror. (Thank you Catobat for the report
          and fix).</li>
        <li>The Village of Outcasts chest game no longer increments the checked locations counter on subsequent
          plays of the game after receiving the game's item. (Patch by CaitSith2)</li>
        <li>New chest key counters exist in the SRAM that may be read by auto-trackers. (Patch by Aerinon)</li>
        <li>The left side of Swamp Palace will now remain flooded if the key has been collected. (Patch by
          CaitSith2)</li>
      ...
      <li>When spoilers is set to "mystery", the intro text will always be the same text, regardless of game settings.
      </li>
      <li>New Maseya-based pallete shuffle algorithm. This new palette shuffle will also shuffle the map's colors!
        Thank you SWR!</li>
      <li>A new "Load Custom Sprite" option is available to let you use your own .zspr file. This allows you to use
        any Link Sprite you wish for racing. Thank you Krelbel for the patch!</li>
      <li>Added new player options<br />
  ...
  <ins class="adsbygoogle" style="display:inline-block;width:100%;height:90px" data-ad-client="ca-pub-5161309967767506"
       data-ad-slot="9849787408"></ins>

  <h2>v31.0.6</h2>
  <div class="card card-body bg-light mb-3">
    <ul>
      <li>This release contains several logic and bug fixes for Entrance Randomizer.</li>
      <li>Entrance Randomizer now fully uses a cryptographically secure pseudo-random number generator for all RNG
        operations.</li>
      ...
      <ul>
        ...
        <li>Inverted - Update Big Bomb Rules (fixes some entrances being in the wrong list or having no routing
          logic applied).</li>
      ...
      <ul>
        <li>Expand mandatory connections logic to account for conditionally accessible entrances, instead of just
          Turtle Rock ledge and Desert ledge.</li>
        <li>Fixed Ganon Silvers hint pointing to the wrong bow.</li>
        <li>Retro - Always require the shop arrow to shoot arrows (progressive silvers don't bypass that
          requirement).</li>
        <li>Retro - Remove arrow capacity upgrades from the upgrade shop.</li>
        <li>Inverted - Fixed rule for the Old Man starting point. Previously, this was in sphere 0 and could cause
          an unbeatable game.</li>
      ...
      <li>Advanced item placement may now require killing Helmasuar King with just Fighter Sword, instead of requiring
        Master Sword. Master Sword is still logically required when using Basic item placement.</li>
      <li>Added new player options<br />
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Silver Arrows will now always be available in Entrance Randomizer when playing Swordless on a hard/expert
        item pool setting.</li>
      <li>Fixed silver arrows being intially equipped on aquisition in Hard/Expert item functionality, even when they
        should only be available for Ganon.</li>
      <li>API support for allowing quickswap usage in item randomizer race ROMs. The default behavior for item
        randomizer races will still be to disallow quickswap.</li>
      <li>Added new player options<br />
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <ul>
        ...
        <li>Ice Palace: Allow access to the right side chests with one Small Key if the Big Key is accessible in a
          right-side chest (this permits access to these locations without the Hookshot).</li>
        <li>Ice Palace: Allow access to the right-side chests in Retro World State, regardless of the Big Key
          location.</li>
        <li>Other miscellaneous glitched logic bug fixes</li>
      </ul>
      <li>The correct number of small keys will be removed from the item pool when choosing Retro World State. This is
        based on the item pool setting (-10 keys for Normal, -15 for Hard and Expert).</li>
      <li>Added additional text selections for Uncle, Blind, Ganon, and joke hints.</li>
      <li>Vanilla swords now properly place all four Progressive Swords in the world, unless the goal is Master Sword
        Pedestal.</li>
      ...
      <li>The hint Ganon provides for the Progressive Bow not found by the player will indicate if Silver Arrows were
        unobtainable. This hint applies to Hard, Expert, and Crowd Control item pool settings.</li>
      <li>Renamed the "Generate ROM" and "Generate ROM (with spoilers)" buttons to "Generate Race ROM" and "Generate
        Normal ROM" to more clearly indicate each button's purpose.</li>
      <li>Added additional checks to ensure that the logic provides some offensive capability in enemy kill rooms if
        the enemy health setting is something other than "Default."</li>
      <li>Customizer: Enemizer options (boss shuffle, enemy shuffle, enemy damage, and enemy health) are now
        available. Customizing boss locations is not yet supported.</li>
      <li>Customizer: It is now possible to manually place Uncle's item when choosing Standard state and randomized
        swords.</li>
      <li>Crowd Control: Properly remove the Bug Catching Net from the Crowd Control item pool. Blue mail armor
        upgrade is also available again in Crowd Control.</li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.31.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/DJUBFGdKIPE?rel=0"
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.30.5.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>In inverted the NPC “thing” in Dark Chapel now instafills your health without any text (but still costs you
        20 rupees!)</li>
      ...
      <li>Bomb/Arrow Capacity Upgrades:<ul>
        <li>Hard: now only sells two +5 upgrades and one +10 upgrade at an increased cost of 200 rupees each
        </li>
        <li>Expert/Insane: removed all capacity upgrades</li>
      </ul>
      </li>
      <li>Updated Old Man so that he still appears if the Purple Chest has been moved but not turned into the Desert
        Thief</li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Updated Sahasrahla’s item location to “is held by the Kakariko village elder” instead of “held by a sage” to
        be clearer</li>
      <li>Big Keys are removed from hints in all modes except Keysanity (except for when they’re in a “worst
        location”)</li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Fixed a bug where the freestanding item in Hera did not increment the Compass item tracker (Easy/Keysanity)
      </li>
      ...
      <li>Fixed a bug where maps/compasses didn’t track correctly in Easy/Keysanity if bosses have a progressive sword
      </li>
      ...
      <li>Easy difficulty starts with 6 hearts and has 3 extra containers in the pool which revert to rupees once you
        have 20</li>
      ...
      <li>Added new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.30.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/vdqTpCH1sCM?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.29.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/xO-ObKYmB2A?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.28.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added many new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.27.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/u8QMJsqMGJw?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added a few new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.26.2.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added many new player options (and updated a few)<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.26.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/L3FdC-f7f38?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Added many new player options<br />
        <img src="https://alttpr-assets.s3.us-east-2.amazonaws.com/sprites.25.lg.png" alt="Player sprite options"
             style="width:50%" />
      </li>
    </ul>
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/n0_SnUraLL8?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      <li>Sword Upgrades are dealt with differently by the fill algorithm to be distributed more evenly over the game
        world.</li>
      <li>New Full Distribution <a
        href="https://docs.google.com/spreadsheets/d/17-_wlQBC6Fnt6qSoAkao1NAEoBXeDUmrGCNX5y7auNA"
        target="_blank" rel="noopener noreferrer">here</a></li>
      <li>Crystals 5 and 6 are now colored red in the menu (once collected) to avoid confusion over which crystal is
        which.</li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      <li>The bookcase in the throne room of Hyrule Castle can now be moved without Zelda once she has been rescued
      </li>
      <li>The logic for the 4 chests in Sewers have had the Gloves requirement removed as you can no longer softlock
      </li>
      <li>The large rock outside Hyrule Castle which is accessible during the rain state has been blocked with guards
      </li>
      ...
      <li>The Arrows HUD icon is now silver when you have Silver Arrows selected in the menu, or found them before Bow
        <ul>
    ...
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/GaUggPXL3M0?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>The frog stays as a frog (spawn in DW) and changes to the smith (spawn in LW) to avoid polarity conflicts
      </li>
      ...
      <li>Statistics of item placements using the new algorithm (100k seeds) can be seen
        <a href="https://docs.google.com/spreadsheets/d/1mAcoPHQM2XRLhrBM2BPeccvhHfoCQNigwlAYASe2Jjs/pubhtml"
           target="_blank" rel="noopener noreferrer">here</a>
      </li>
      <li>Masochist has been renamed to Expert</li>
      <li>Powdering anti-faeries turns them into single hearts [hard]</li>
      <li>Bottles can be found prefilled with everything except faeries (including from Great Faeries) [hard/expert]
      </li>
    ...
    <div class="card border-info mt-4">
      ...
      <div class="card-body">
        <div class="embed-responsive embed-responsive-16by9">
          <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/YCTbYA_eVNw?rel=0"
                  allowfullscreen></iframe>
        </div>
      </div>
    </div>
  ...
  <div class="card card-body bg-light mb-3">
    ...
    <div class="card card-body bg-light mb-3">
      ...
      <ul>
        ...
        <li>The arrow and bomb capacity upgrades are split over six +5 upgrades and one +10 upgrade (as per vanilla)
          <ul>
            ...
            <li>The 50 bomb and 70 arrow capacity upgrades have been removed (will feature in later versions)
            </li>
          </ul>
        </li>
        <li>The Master Sword pedestal, Smithy and Fat Faerie are now regular item locations and the swords are in
          the pool<ul>
            <li>Master Sword pedestal: This gives you the item without changing your sword</li>
            <li>Smithy: He gives you his item in exchange for 10 rupees and skips the tempering process (switch)
            </li>
        ...
        <li>The drop pool also includes the rupee crab (2 prizes), stunned enemies (1 prize) and saved fish (1
          prize)</li>
        ...
        <li>Enemy prize packs now randomizes both the enemies and the prizes<ul>
          <li>The Book of Mudora translates the Hylian text at the Master Sword pedestal to tell you what the
            item is</li>
        </ul>
        </li>
        ...
        <li>Lots and lots of text updates, translation to English and removal, including the opening credits
          sequence!</li>
        <li>Link’s House can now contain the Fire Shield and Mirror Shield</li>
        <li>Link’s Uncle no longer gives you the Fighter’s Shield (also removed from his sprite) and it is part of
          the item pool</li>
        ...
        <li>The Smithy no longer has Mirror as a forced requirement as he will persist through s+q as per vanilla
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>The door to Aghanim's Tower is now locked until Zelda has been rescued (prevents issues with game states)
      </li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Throwing bottles into Faerie fountains now yields an equal chance for each bottle prize, including empty
      </li>
      ...
      <li>Bottles do not auto-open when selected in the menu; instead you open with X and toggle between them with Y
      </li>
      <li>Dying/s+q from a non-dungeon underworld room in the DW now correctly takes you back to LW (error with v3.5)
      </li>
      ...
      <li>Logic improvements (rewritten algorithms to improve item distribution, removal of Hammer/Mitts restrictions)
      </li>
  ...
  <div class="card card-body bg-light mb-3">
    <ul>
      ...
      <li>Playing flute for flute boy will not cause him to disappear (although he disappears after receiving his
        item)</li>
      ...
      <li>Invisible follower fix (s+q/flute after Master Sword before getting the log text now removes the invisible
        follower)</li>
      ...
      <li>Five 100 rupee prizes were added to the prize pool (replaced three red rupees and the two duplicate Lamps)
      </li>
      <li>Swamp’s first room correctly empties when leaving the LW and DW overworld screens (error with v1.2)</li>
      <li>Link instantly dies and all faeries are removed if damage is taken during fake flippers after transitioning
        screens</li>
    </ul>
  </div>
